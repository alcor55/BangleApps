...
Graphics.prototype.setFontQuicksand = function() {
  ...
  // 1 BPP
  return this.setFontCustom(
    E.toString(require('heatshrink').decompress(atob(''))),
    46,
    atob("CyUnFCUiJCQlIyQlCw=="),
    70|65536
  );
};
  ...
  let drawClock = function() {
    ...
    g.reset().setColor(cleanColor).fillRect(X, Y, X+165, Y+53).setColor(drawingColor); // Clear.
    g.setFontAlign(0, 0).setFontQuicksand().drawString(timeStr, X+81, Y+31);
  };
